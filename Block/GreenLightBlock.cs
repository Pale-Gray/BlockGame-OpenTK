...
{
    internal class GreenLightBlock : Block
    {

        public GreenLightBlock()
        {

            SetProperties(LoadFromJson("GreenLightBlock.json"));

        }

        public override void OnBlockSet(Chunk chunk, Vector3i localBlockPosition)
        {
            chunk.SetBlockLight(localBlockPosition, (0, 15, 0));
        ...
        public override void OnBlockPlace(World world, BlockProperties blockProperties, Vector3i globalBlockPosition)
        {
            ...
            world.AddBlockLight(globalBlockPosition, (0, 15, 0));
